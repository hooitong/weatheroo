...
import static co.realityshifters.weatheroo.data.TestUtilities.getConstantNameByStringValue;
import static co.realityshifters.weatheroo.data.TestUtilities.getStaticIntegerField;
import static co.realityshifters.weatheroo.data.TestUtilities.getStaticStringField;
import static co.realityshifters.weatheroo.data.TestUtilities.studentReadableClassNotFound;
import static co.realityshifters.weatheroo.data.TestUtilities.studentReadableNoSuchField;
...
public class TestSunshineDatabase {
    ...
    public void before() {
        try {
            ...
            if (weatherDbHelperSuperclass == null || weatherDbHelperSuperclass.equals(
                    Object.class)) {
                String noExplicitSuperclass =
                        "WeatherDbHelper needs to extend SQLiteOpenHelper, but yours currently "
                                + "doesn't extend a class at all.";
            ...
            Method getWritableDatabase = SQLiteOpenHelper.class.getDeclaredMethod(
                    "getWritableDatabase");
     ...
     * <p>
     * {@link co.realityshifters.weatheroo.data.WeatherContract.WeatherEntry#TABLE_NAME}.
     * <p>
